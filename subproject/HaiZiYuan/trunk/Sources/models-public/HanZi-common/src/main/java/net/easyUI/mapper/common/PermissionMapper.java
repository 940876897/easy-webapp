...
public interface PermissionMapper {
	 ...
	 * @return
	 */
	public Permission getByKey(Long id);
	public Permission getByKeyFullFK(Long id);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List<Permission> listQueryMap(Map queryMap, RowBounds rowBounds);
	@SuppressWarnings("rawtypes")
	public List<Permission> listQueryMapFullFK(Map queryMap, RowBounds rowBounds);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List<Permission> listQueryMap(Map queryMap);
	@SuppressWarnings("rawtypes")
	public List<Permission> listQueryMapFullFK(Map queryMap);
	 ...
	 * 根据唯一字段{column.columnName}查询单条记录
	 */
	public int deleteByUkPermissionKey(String v) ;
