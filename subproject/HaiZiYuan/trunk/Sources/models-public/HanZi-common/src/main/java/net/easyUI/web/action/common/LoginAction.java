...
public class LoginAction extends BaseAction {
	...
	DwzJson userLogoutJson(Cookyjar cookyjar) throws Exception {
		...
		DwzJson dwzJson = new DwzJson(EnumDwzJsonStatusType.OK.getCode(),
				...
				EnumDwzJsonCallbackType.FORWARD.getCode(), "/loginPage.htm");
		return dwzJson;
	}
	...
	public String loginAjaxPage(
		...
		// model.put("action", appServerBroker.get("loginAjax.htm"));
		// else if ("page".equalsIgnoreCase(actionType))
		// model.put("action", appServerBroker.get("login.htm"));
		// else if ("defaultPage".equalsIgnoreCase(actionType))
		// model.put("action", appServerBroker.get("loginDefault.htm"));
		// else
		// model.put("action", appServerBroker.get("loginJson.htm"));
