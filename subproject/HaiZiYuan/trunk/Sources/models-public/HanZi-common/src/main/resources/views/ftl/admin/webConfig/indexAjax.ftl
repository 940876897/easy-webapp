...
<form id="pagerForm" action="${appServer!""}/admin/webConfig/indexAjax.htm" method="post">
...
<div class="pageHeader">
    <form onsubmit="return navTabSearch(this,'dwz_tab_webConfig');" action="${appServer!""}/admin/webConfig/indexAjax.htm" method="post">
		<#include "/admin/include/dwzFormBaseQuery.ftl">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="${appServer!""}/admin/webConfig/addAjax.htm?cfgGroup=${(cfgGroup!"")?url}&navTabId=${dwz.dwzId!""}&dwzId=${dwz.dwzId!""}_add" target="navTab" title="<@s.message "function.add" /><@s.message "WebConfig" />" rel="${dwz.dwzId!""}_add"><span><@s.message "function.add" /></span></a></li>
            <li><a href="${appServer!""}/admin/webConfig/editAjax/{id}.htm?cfgGroup=${(cfgGroup!"")?url}&navTabId=${dwz.dwzId!""}&dwzId=${dwz.dwzId!""}_edit" target="navTab" class="edit" title="<@s.message "function.edit" /><@s.message "WebConfig" />" rel="${dwz.dwzId!""}_edit" ><span><@s.message "function.edit" /></span></a></li>
            <li class="line">line</li>
<!--
            <li><a href="${appServer!""}/admin/webConfig/delJson.json?navTabId=${dwz.dwzId!""}&callbackType=forward" target="selectedTodo" class="delete" title="确实要<@s.message "function.delBatch" />这些<@s.message "WebConfig" />吗?"><span><@s.message "function.delBatch" /></span></a></li>
-->
            <li><a href="${appServer!""}/admin/webConfig/delJson/{id}.json?navTabId=${dwz.dwzId!""}&callbackType=forward" target="ajaxTodo" class="delete" title="你确定要<@s.message "function.del" />选择这条<@s.message "WebConfig" />吗?"><span><@s.message "function.del" /></span></a></li>
        </ul>
    </div>
    <table class="table" width="100%" layoutH="138" nowrapTD="false">
        ...
        <tbody>
	       ...
	       <tr target="id" rel="${rs.id!""}"> <!-- target="id" rel="${rs.id!""}" 这两个是用在AjaxURL中的占位({target})数据(rel)来源 -->
	            ...
	            <td >
	                <a href="${appServer!""}/admin/webConfig/editAjax/${rs.id?url}.htm?cfgGroup=${cfgGroup!""?url}&navTabId=${dwz.dwzId!""}&dwzId=${dwz.dwzId!""}_edit_${rs.id!""}" target="navTab" title="<@s.message "function.edit" /><@s.message "WebConfig" />[${rs.id!""}]" class="btnEdit"  rel="${dwz.dwzId!""}_edit_${rs.id!""}" ><@s.message "function.edit" /></a>
	            	<a href="${appServer!""}/admin/webConfig/delJson/${rs.id?url}.json?navTabId=${dwz.dwzId!""}&callbackType=forward" target="ajaxTodo" title="你确定要<@s.message "function.del" />这个<@s.message "WebConfig" />[${rs.id!""}]吗?" class="btnDel" ><@s.message "function.del" /></a>
               <!--如果有1对多,可加上查看多方列表按钮
                -->
                </td>
	        </tr>
