...
<#if (operType!"")=="edit"|| (operType!"")=="add">
        action="${appServer!""}/admin/webConfig/save/json.json" 
...
<#else>
        ...
        <dl> 
            <dt><@s.message "WebConfig.cfgName" />：</dt> 
            <dd> 
        ...
        <dl> 
            <dt><@s.message "WebConfig.cfgTitle" />：</dt> 
            <dd> 
        ...
        <dl> 
            ...
            <dd> <!-- EnumWebCfgGroup -->
                	<@m.enumSelectEl  EnumWebCfgGroupList   s.status.expression!""  s.status.value!""  ""  ""   "required"/>
            </dd> 
        </dl> 
...
<#assign editor_tmp_id=_UUID.generate() />
            <dl class="nowrap"> 
                <dt><@s.message "WebConfig.cfgValue" />：
                	<br/><a class="button" href="javascript:euFn.codeEdit.showEditor('${editor_tmp_id!""}');"><span>code编辑</span></a>
                </dt> 
                <dd> 
            ...
            <script>euFn.codeEdit.showEditor('${editor_tmp_id!""}');</script>
        ...
        <dl> 
            <dt><@s.message "WebConfig.meta32" />：</dt> 
            <dd> 
