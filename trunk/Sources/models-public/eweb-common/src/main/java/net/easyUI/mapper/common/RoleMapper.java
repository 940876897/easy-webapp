...
public interface RoleMapper {
	...
	public Role getByKeyFullFK(Long id);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List<Role> listQueryMap(Map queryMap, RowBounds rowBounds);
	@SuppressWarnings("rawtypes")
	public List<Role> listQueryMapFullFK(Map queryMap, RowBounds rowBounds);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List<Role> listQueryMap(Map queryMap);
	@SuppressWarnings("rawtypes")
	public List<Role> listQueryMapFullFK(Map queryMap);
	 ...
	 * 根据唯一字段{column.columnName}查询单条记录
	 */
	public int deleteByUkRoleKey(String v) ;
