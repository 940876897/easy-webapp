...
public interface UserMapper {
	...
	public User getByKeyFullFK(Long id);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List<User> listQueryMap(Map queryMap, RowBounds rowBounds);
	@SuppressWarnings("rawtypes")
	public List<User> listQueryMapFullFK(Map queryMap, RowBounds rowBounds);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public List<User> listQueryMap(Map queryMap);
	@SuppressWarnings("rawtypes")
	public List<User> listQueryMapFullFK(Map queryMap);
	 ...
	 * 根据唯一字段{column.columnName}查询单条记录
	 */
	public int deleteByUkLoginName(String v) ;
