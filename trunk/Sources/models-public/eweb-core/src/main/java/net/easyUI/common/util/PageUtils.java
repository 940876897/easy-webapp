...
public class PageUtils {
	...
	public static List generateLinkPageNumbers(int currentPageNumber,
	...
	public static int computeLastPageNumber(long totalElements, int pageSize) {
		int result = (int)(totalElements % pageSize != 0 ? totalElements / pageSize
				+ 1 : totalElements / pageSize);
		if (result <= 1)
			result = 1;
		return result;
	}
