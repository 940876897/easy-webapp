...
import net.easyUI.common.web.url.StampURLBroker;
import net.easyUI.common.web.url.URLBroker;
...
public class BaseAction {
	...
	@Autowired
	protected URLBroker sslAppServerBroker;
	@Autowired
	protected StampURLBroker imageServerBroker;
	@Autowired
	...
	protected String redirect(String url) {
		return "redirect:" + appServerBroker.get(url);
	}

	protected String redirectLogin() {
		return redirect("/loginPage.xhtml");
	}
